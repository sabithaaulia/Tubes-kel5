    ...
    <div class="px-5">
        ...
        <div class="row row-cols-1">
            ...
            <?php if(Session::has('MessageDeleteTable')): ?>
                <div class="alert alert-danger alert-lg"> <?php echo e(Session::get('MessageDeleteTable')); ?></div>
            <?php endif; ?>
            <div class="col">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\gaizka\Documents\tugas vincentius gaizka cannavaro\teluten-main\teluten-main\resources\views/locationfacilities.blade.php ENDPATH**/ ?>